> 一直对vue很感兴趣，最近使用vue2.0开发了饿了么点餐系统来练练手，不得不说vue真是一个很不错的框架，但是也遇到过一些坑，在这里和大家分享一下
...
<a href="http://www.51nannan.cn/sell/sell.index" target=_blank>在线演示戳我</a>（请使用chrome开发者手机演示模式预览）
